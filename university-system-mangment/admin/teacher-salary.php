<?php  
  ...
  require_once "../config/config.php";
 	...
 	if (isset($_POST['btn_save'])) {
 		...
 		$query=
    "INSERT INTO 
      teacher_salary_allowances(teacher_id,basic_salary,medical_allowance,hr_allowance,scale)
    VALUES
      ('$teacher_id','$basic_salary','$medical_allowance','$hr_allowance','$scale')
    ";
								...
								<div class="col-md-12">
									<table class="w-100 table-elements table-three-tr" cellpadding="3">
										...
										<?php  
											$query=
											"SELECT 
											  ti.teacher_id,ti.first_name,ti.middle_name,ti.last_name,salary_id,basic_salary,medical_allowance,hr_allowance,scale,Date(paid_date) AS paid_date,total_amount 
											FROM 
											  teacher_salary_allowances AS tsa 
											INNER JOIN 
											  teacher_salary_report AS tsr ON tsa.teacher_id = tsr.teacher_id 
											INNER JOIN 
											  teacher_info AS ti ON ti.teacher_id = tsr.salary_id";
