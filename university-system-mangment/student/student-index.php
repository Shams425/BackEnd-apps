								...
								<div class="collapse show mt-2" id="collapseOne">
									<table class="w-100 table-elements table-two-tr"cellpadding="2">
										...
										<?php $roll_no=$_SESSION['LoginStudent'];
											...
											$query=
                      "SELECT 
                        sc.subject_code,cs.subject_name,sc.semester,cs.credit_hours, sc.roll_no, sc.semester 
                      FROM 
                        student_courses AS sc 
                      INNER JOIN
                        course_subjects AS cs ON sc.subject_code = cs.subject_code 
                      WHERE 
                        sc.roll_no = '$roll_no' AND sc.semester = $semester
                      ";
				...
				<div class="row">
					<div class="col-lg-6 col-md-12 col-sm-12">
                      ...
                      "SELECT * FROM 
                        student_courses 
                      INNER JOIN 
                        course_subjects on student_courses.subject_code = course_subjects.subject_code 
                      WHERE 
                        student_courses.roll_no = '$roll_no' AND student_courses.semester = '$semester'
                      ";
								...
								<div class="collapse show mt-2" id="collapsefour">
									<table class="w-100 table-elements table-one-tr"cellpadding="2">
										...
										<?php 
											...
											$query=
                      "SELECT 
                        COUNT(attendance_id) AS attendance_id, SUM(attendance) AS attendance,student_id 
                      FROM 
                        student_attendance 
                      WHERE 
                        student_id='$roll_no'";
