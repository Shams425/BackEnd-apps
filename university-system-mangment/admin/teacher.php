...
<?php  
	if (isset($_POST['btn_save2'])) {
		...
		$query3 =
    "INSERT INTO 
      teacher_courses(course_code,semester,teacher_id,subject_code,assign_date,total_classes)
    VALUES
      ('$course_code','$semester','$teacher_id','$subject_code','$date','$total_classes')
    ";
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
			<div class="sub-main">
				...
				<div class="row w-100">
                  ...
                  $query=
                  "SELECT 
                    teacher_id,first_name,middle_name,last_name,current_address,ma_certificate,hire_date,email 
                  FROM 
                    teacher_info";
                  $run=mysqli_query($con,$query);
