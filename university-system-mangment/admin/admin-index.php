					...
					<div>
						<section class="mt-3">
							<div class="btn btn-block table-two text-light d-flex">
								...
								<a href="" class="ml-auto" data-toggle="collapse" data-target="#collapsetwo">
							...
							<div class="collapse show mt-2" id="collapsethree">
								<table class="w-100 table-elements table-three-tr"cellpadding="2">
									...
									<?php  
										$query=
										"SELECT 
										  course_code, course_name, semester, count(subject_code) AS subject_code,sum(credit_hours) AS credit_hours 
										FROM 
										  course_subjects 
										JOIN 
										  courses 
