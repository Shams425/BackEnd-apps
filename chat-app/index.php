      ...
      <section class="contentContainer sign-up">
        <div class="wrapper">
          ...
          <form action="#" enctype="multipart/form-data" method="POST">
            ...
            <div class="alert alert-danger mt-3 text-center"></div>
            ...
            <div class="email form-group mb-3">
              ...
              <input type="email" name="email" required="true" class="form-control" placeholder="Enter You E-mail" />
            </div>
            ...
            <div class="password form-group mb-3">
              ...
              <input type="password" name="rePassword" required="true" class="form-control"
            ...
            <div class="form-group mt-5 text-center button">
              <input type="submit" name="send" class="btn btn-dark" value="Start Chatting" />
            </div>
          </form>
