  ...
  require_once "../config/config.php";
	...
	if (isset($_POST['sub'])) {
		...
		for ($i=0; $i < $count; $i++) { 
			...
			$que=
			"INSERT INTO 
			  student_courses(course_code,semester,roll_no,subject_code,assign_date)
			VALUES
			  ('".$_POST['course_code'][$i]."','".$_POST['semester'][$i]."','".$_POST['roll_no'][$i]."','".$_POST['subject_code'][$i]."','$date')
			";
			...
			<div class="sub-main">
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						?>
						<h5 class="py-2 pl-3 <?php echo $bg_color; ?>"><?php echo $message ?></h5>
					</div>
