<?php  
  ...
  require_once "../config/config.php";
    ...
    "UPDATE 
      teacher_info 
    SET 
      first_name='$first_name', middle_name='$middle_name', last_name='$last_name', father_name='$father_name',
      cnic='$cnic', phone_no='$phone_no', gender='$gender', current_address='$current_address',
      permanent_address='$permanent_address', place_of_birth='$place_of_birth', last_qualification='$last_qualification',
      state='$state' 
    WHERE 
